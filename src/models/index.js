...
db.Withdrawal = require('./Withdrawal')(sequelize);
...
db.User.hasMany(db.Withdrawal, { foreignKey: 'userId', as: 'withdrawals' });
db.Withdrawal.belongsTo(db.User, { foreignKey: 'userId', as: 'user' });
